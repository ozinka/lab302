...
from qt_core import *
from gui.windows.main_window.tab_explore import TabExplore
...
"}")
        ...
        self.btn_change_text.setObjectName("btn_change_text")
        self.btn_change_text.setText('Press_me')
        self.btn_change_text.setMinimumSize(QSize(120, 36))
        self.btn_change_text.setMaximumSize(QSize(16777215, 36))
        self.btn_change_text.setStyleSheet("QPushButton {\n"
...
"}")
        ...
        self.page_3 = TabExplore()
        self.page_3.setObjectName("tab_explore")
